...
class SimpleSquareWithTriObjsEnvSecond(AbstractMeshEnv):
    def __init__(self,partial,size,
        ...
        self._slashForward = slashForward
    ...
    def reset(self):
        ...
        obj = WorldGeneratorForSecondConvNetworkTest(self._gameObjIndexX, self._gameObjIndexY,
                         self._realCorner, self._slashForward, self._horiMove, self._vertMove)
        ...
        hero.setNorthEast(self.objects[-3].getNorthEast()[0], self.objects[-3].getNorthEast()[1])
        
        
        heroMoveVector = self.calculateTipMovementVector(self._gameObjTipDirection,3)
